...
export default {
    ...
    methods: {
        ...
        api_comment()
        {
            this.axios.get(this.$store.state.API_URL + 'comment_room/'+this.$f7route.params.UUID).then((response) => {
        ...
        comment_karaoke()
        {
            if(this.$session.has('token'))
            {
                if(this.value_comment != '')
                {
                    ...
                    data.append("CONTENT_ROOM",this.value_comment)
                    this.axios.post(this.$store.state.API_URL + 'comment_room?api_token='+this.$session.get('token'),data).then(() => {
                        this.value_comment  = ''
                        this.api_comment()
                        this.likeRoom() 
        ...
        ApiRating(i)
        {
            this.$http.get(this.$store.state.API_URL + 'room/'+this.$f7route.params.UUID 
