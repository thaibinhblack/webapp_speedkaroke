...
<div id="page-cameara">
    <f7-block>
        ...
        <f7-col width="33" class="media-cameara" v-for="(image,index) in images" :key="index"><img :src="image.URL_IMAGE" height="100%" width="100%"  @click="$refs.pageDark.open()"></f7-col>
