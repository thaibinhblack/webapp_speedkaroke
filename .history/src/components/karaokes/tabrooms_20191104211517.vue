            ...
            <f7-col v-for="(room,index) in rooms" :key="index">
                <f7-link>
                    ...
                    <div class="content-room">
                        ...
                        <P><f7-icon v-for="(star,index) in Math.floor(room.STAR_RATING)" :key="index" color="yellow"  ios="material:star" aurora="material:star" md="material:star"></f7-icon>, ({{room.NUMBER_RATED}})</P>
                    </div>
                </f7-link>
            </f7-col>
        </f7-row>
