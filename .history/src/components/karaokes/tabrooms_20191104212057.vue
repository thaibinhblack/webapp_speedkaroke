...
<div id="page-rooms">
    <f7-block>
        <f7-row>
            <f7-col width="100%" class="text-title">Danh sách phòng karaoke của chi nhánh</f7-col>
            <f7-col width="100%" v-for="(room,index) in rooms" :key="index" class="item-room">
...
<style scoped>
.text-title {font-size: 16px;margin-bottom: 15px;}
