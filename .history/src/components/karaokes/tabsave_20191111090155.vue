...
<f7-page>
    <f7-block>
        ...
        <span><star-rating :star-size="18" :increment="0.5" :rating="karaoke.STAR_RATING" :show-rating="false" 
...
export default {
    ...
    methods: {
        ...
        ApiRating(i)
        {
            this.$http.get(this.$store.state.API_URL + 'karaoke/'+this.$f7route.params.UUID 
