...
<f7-page>
    <f7-block>
        <h3 align="center" style="margin-bottom:15px;">Hãy để lại nhận xét của bạn để chi nhánh phát triển hơn!</h3>
        <f7-row>
            ...
            <f7-col>
                <f7-button style="text-align:right">Bình luận</f7-button>
            </f7-col>
        </f7-row>
    </f7-block>
</f7-page>
