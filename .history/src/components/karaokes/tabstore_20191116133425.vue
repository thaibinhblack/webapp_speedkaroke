...
<div class="banner-karaoke" v-if="karaoke.UUID_BAR_KARAOKE">
    ...
    <f7-block>
        <div class="main-content">
             <button class="btn-save" style="width:120px;"><f7-icon ios="material:save" aurora="material:save" md="material:save" ></f7-icon> Lưu lại</button>
...
.btn-save {background: transparent; margin-left: 15px;border: none;box-shadow: none; cursor: pointer;}
</style>