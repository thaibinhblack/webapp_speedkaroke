...
export default {
    ...
    methods: {
        ...
        api_check_promotion(code)
        {
            this.axios.get('http://127.0.0.1:800/api/v1/promotion/'+this.booking.UUID_BAR_KARAOKE+'/check?CODE_PROMOTION='+this.code_promotio).then((response) =>{
                console.log(response.data)
            })
        }
    },
