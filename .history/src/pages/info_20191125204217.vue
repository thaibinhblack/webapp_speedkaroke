        ...
        <f7-tab id="speedcoin">
            <f7-block>
                ...
                <form action="">
                    ...
                    <div class="form-group row">
                        <label for="speedcoin" class="col-sm-4 col-xs-5 col-4 col-form-label">Hình thức đổi</label>
                        <div class="col-sm-8 col-8 col-xs-7">
                             <select class="form-control" id="v" v-model="action_speed_coin"> 
                                 <option value="null">Chọn hình thức đổi</option>
                                <option value="0">Đổi điểm tích lũy thành speed coin</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row" v-if="action_speed_coin == 0"> 
                        <label for="speedcoin" class="col-sm-4 col-xs-5 col-4 col-form-label">Điểm tích lũy</label>
                        <div class="col-sm-8 col-8 col-xs-7">
                            <input disabled type="text" v-model="user.RELIABILITY" class="form-control" id="speedcoin" placeholder="Điểm tích lũy" />
                        </div>
                    </div>
                    <div class="form-group row" v-if="action_speed_coin == 0"> 
                        <label for="speedcoin" class="col-sm-4 col-xs-5 col-4 col-form-label">Chọn điểm quy đổi</label>
                        <div class="col-sm-8 col-8 col-xs-7">
                            <input type="number" class="form-control" id="speedcoin" placeholder="Điểm tích lũy" />
                        </div>
                    </div>
                </form>
            </f7-block>
