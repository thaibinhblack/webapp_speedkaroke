    ...
    <f7-block>
      <f7-row>
        <f7-col class="text-new tab active">
          <f7-link href="/form/"><span class="tabs" >Mới nhất</span></f7-link>
        </f7-col>
      ...
      <f7-row>
        <f7-col v-for="(karaoke,index) in karaoke_new" :key="index" width="50" style="padding:4px">
          <f7-card class="item-karaoke" style="margin:0">
              <f7-link :href="'/karaoke/'+karaoke.UUID_BAR_KARAOKE+'/'" :animate="false" :ignore-cache="true"><img clas="image-karaoke" width="100%" height="100px" :src="$store.state.PUBLIC_URL+karaoke.BANNER_BAR_KARAOKE" :alt="karaoke.NAME_BAR_KARAOKE"></f7-link>
