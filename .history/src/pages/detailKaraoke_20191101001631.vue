...
<f7-page name="detail-karaoke">
    ...
    <f7-toolbar top tabbar labels>
      <f7-link no-link-class no-fast-click	 class="camera">
        <f7-icon class="icon-fill" ios="material:camera" aurora="material:camera" md="material:camera">
        </f7-icon>
       <small>Tải hình </small>
        <input class="input-camera" type="file" accept="image/*" ref="uploadImage" multiple>
      </f7-link>
...
.input-camera {position: absolute;top: 0;left: 0;width: 100%;height: 100%;z-index: 999;}
</style>