...
<f7-page dark>
    ...
    <f7-list class="list-accout">
        <f7-list-item title="Mời bạn bè" link="/send-firend/">
            <f7-icon color="#ee350f" ios="material:account" aurora="material:account" md="material:account" slot="media"></f7-icon>
        </f7-list-item>
    ...
    <f7-list class="list-accout">
        <f7-list-item title="Chính sách quy định" link="/question/">
            <f7-icon color="#ee350f" ios="material:question" aurora="material:question" md="material:question" slot="media"></f7-icon>
        </f7-list-item>
        <f7-list-item title="Cà đặt" link="/setting/">
            <f7-icon color="#ee350f" ios="material:setting" aurora="material:setting" md="material:setting" slot="media"></f7-icon>
        </f7-list-item>
    </f7-list>
