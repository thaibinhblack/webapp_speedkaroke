            ...
            <f7-block>
                <form action="">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-8 col-xs-7">
                                <input disabled type="text" v-model="password.new_password" class="form-control" id="speedcoin" placeholder="Nhập mật khẩu mới" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="speedcoin" class="col-sm-4 col-xs-5 col-4 col-form-label" >Nhập mật khẩu mới xác thực</label>
                        <div class="col-sm-8 col-8 col-xs-7">
                                <input disabled type="text" v-model="password.confirm_password" class="form-control" id="speedcoin" placeholder="Nhập lại mật khẩu xác thực" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-9">
                            <button type="submit" :disabled="update"  class="btn btn-primary btn-form">Cập nhật mật khẩu</button>
