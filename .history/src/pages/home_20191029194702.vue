...
export default {
  ...
  methods: {
    getKaraokeNew()
    {
      axios.get("https://speedkaraoke.herokuapp.com/api/v1/karaoke?page=1").then((response) => {
    ...
    ApiGetProvince()
    {
      axios.get("https://speedkaraoke.herokuapp.com/api/v1/province").then((response) => {
      ...
      navigator.geolocation.getCurrentPosition(function(location) {
       axios.get('https://api.opencagedata.com/geocode/v1/json?q='+location.coords.latitude+'+'+location.coords.longitude+'&key=2d3fed69d9404855bf934ad52e5c1d65&pretty=1')
                .then((response) => {
                  ...
                  axios.post("https://speedkaraoke.herokuapp.com/api/v1/province/search",search).then((response) => {
                    this.karaoke_new = response.data
                    this.karaoke_tmp = response.data
                    const self = this;
                    self.$f7.dialog.preloader();
