...
<f7-page name="detail-karaoke">
    ...
    <f7-tabs animated>
        ...
        <f7-block>
            ...
            <f7-icon v-for="(star ,index) in stars" class="star-rating" :key="index" :class="star.class" @click="rating(index)"  ios="material:star" aurora="material:star" md="material:star">
            </f7-icon>
        </f7-block>
        </f7-tab>
