        ...
        <f7-subnavbar :inner="false">
          <f7-row class="top-header">
              <f7-col width="60" class="search">
                 ...
                 <f7-link href="/search" style="text-align:left;justify-content: left;">  <f7-icon ios="material:search" aurora="material:search" md="material:search"></f7-icon> <small>Nhập từ khóa tìm kiếm karaoke</small></f7-link>
              </f7-col>
