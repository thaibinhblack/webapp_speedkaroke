<template>
  <f7-page name="home">
    ...
    <f7-block>
      <f7-row>
        <f7-col v-for="(karaoke,index) in karaoke_new" :key="index" width="50">
          <f7-card>
              <img clas="image-karaoke" :src="'https://speedkaraoke.herokuapp.com/'+karaoke.BANNER_BAR_KARAOKE" :alt="karaoke.NAME_BAR_KARAOKE">
          </f7-card>
        </f7-col>
      </f7-row>
    </f7-block>
...
export default {
  ...
  created()
  {
    navigator.geolocation.getCurrentPosition(function(location) {
       this.$http.get('https://api.opencagedata.com/geocode/v1/json?q='+location.coords.latitude+'+'+location.coords.longitude+'&key=2d3fed69d9404855bf934ad52e5c1d65&pretty=1')
                .then((response) => {
...
.image-karaoke {width: 100%;height: 180px;}
</style>