      ...
      <f7-row>
        <f7-col v-for="(karaoke,index) in karaoke_new" :key="index" width="50" style="padding:4px">
          <f7-card class="item-karaoke" style="margin:0">
              <f7-link :link="'/karaoke/'+karaoke.UUID_BAR_KARAOKE"><img clas="image-karaoke" width="100%" height="100px" :src="$store.state.PUBLIC_URL+karaoke.BANNER_BAR_KARAOKE" :alt="karaoke.NAME_BAR_KARAOKE"></f7-link>
